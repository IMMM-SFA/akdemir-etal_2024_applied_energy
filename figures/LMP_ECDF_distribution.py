...
ax[0,0].set_ylabel('Proportion', weight='bold')
ax[1,0].set_ylabel('Proportion', weight='bold')
...
ax[0,0].set_xlim([30,110])
ax[0,1].set_xlim([40,70])
ax[1,0].set_xlim([10,70])
ax[1,1].set_xlim([20,240])

ax[0,0].set_xticks([30,40,50,60,70,80,90,100,110])
ax[1,1].set_xticks([20,40,60,80,100,120,140,160,180,200,220,240])
...
fig.legend(handles=handles,loc='center left', bbox_to_anchor=(0.08, 0.42), ncol=1, fontsize=12)
...
ax[0,0].set_xlim([-100,1400])
ax[0,1].set_xlim([-100,2000])
ax[1,0].set_xlim([-100,1400])
ax[1,1].set_xlim([-100,1200])

ax[0,0].set_xticks([-100,0,200,400,600,800,1000,1200,1400])
ax[0,0].set_xticklabels(['',0,200,400,600,800,1000,1200,1400])
ax[0,1].set_xticks([-100,0,250,500,750,1000,1250,1500,1750,2000])
ax[0,1].set_xticklabels(['',0,250,500,750,1000,1250,1500,1750,2000])
ax[1,0].set_xticks([-100,0,200,400,600,800,1000,1200,1400,1600])
ax[1,0].set_xticklabels(['',0,200,400,600,800,1000,1200,1400,1600])
ax[1,1].set_xticks([-100,0,200,400,600,800,1000,1200])
ax[1,1].set_xticklabels(['',0,200,400,600,800,1000,1200])
...
fig.legend(handles=handles,loc='center left', bbox_to_anchor=(0.27, 0.115), ncol=1, fontsize=12)
